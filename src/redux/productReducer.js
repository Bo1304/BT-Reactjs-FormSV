const initalState = {
  products: [
    ...
    },
    {
      ...
      imgSrc_png: "./images/background/background5.jpg",
    },
    {
      id: "background_6",
      type: "background",
      ...
      imgSrc_png: "./images/background/background6.jpg",
    },
    {
      id: "background_7",
      type: "background",
...
const reducer = (state = initalState, { type, payload }) => {
  switch (type) {
    case "product/UPDATE_SELECTED_PRODUCT":
      const updatedSelectedProducts = { ...state.selectedProducts };
      updatedSelectedProducts[payload.type] = payload.img;
